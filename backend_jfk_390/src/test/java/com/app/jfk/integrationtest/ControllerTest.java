package com.app.jfk.integrationtest;
...
class ControllerTest {
  ...
  void  testRetrieveMetadataDocument() {
    ...
    assertNotNull(n);
    assertEquals("jfk", n.getAttribute("Namespace"));
  ...
  void  testCreateEmployeePersonalInfoInstance() throws IOException {
    given()
        ...
        .when()
        .post("/jfk/EmployeePersonalInfoes")
        .then()
        .statusCode(HttpStatusCode.CREATED.getStatusCode());
  ...
  given()
   ...
   given()
            .when()
            .get("/jfk/EmployeePersonalInfoes?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/jfk/EmployeePersonalInfoes/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  given()
   ...
   given()
            .when()
            .get("/jfk/EmlpoyeeProfiles?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/jfk/EmlpoyeeProfiles/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM jfk_108.Organization");
    jdbcTemplate.execute("DELETE FROM jfk_108.EmployeePersonalInfo");
    jdbcTemplate.execute("DELETE FROM jfk_108.EmlpoyeeProfile");
